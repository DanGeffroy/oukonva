...
export const manifest: Partial<ManifestOptions> = {
  name: "Oukonva", // Change this to your website's name.
  short_name: "Oukonva", // Change this to your website's short name.
  description: "Oukonva ce swar", // Change this to your websites description.
